...
export const DICTIONARY: Record<string, Translations> = {
  en: {
    ...
    questions: [
      ...
      "How has this affected your sleep, daily routine, or stress levels?",
      "Have you noticed any physical feelings like tension, fatigue, or restlessness?",
      "What hope or goals do you have for your therapy sessions?"
    ]
  },
  kn: {
    navHome: "ಮುಖಪುಟ",
    ...
    questions: [
      ...
      "ಇದು ನಿಮ್ಮ ನಿದ್ರೆ, ದೈನಂದಿನ ದಿನಚರಿ ಅಥವಾ ಒತ್ತಡದ ಮಟ್ಟವನ್ನು ಹೇಗೆ ಬಾಧಿಸಿದೆ?",
      "ನೀವು ಆಯಾಸ ಅಥವಾ ಅಶಾಂತಿಯಂತಹ ದೈಹಿಕ ಭಾವನೆಗಳನ್ನು ಗಮನಿಸಿದ್ದೀರಾ?",
      "ನಿಮ್ಮ ಥೆರಪಿ ಸೆಷನ್‌ಗಳಿಂದ ನೀವು ಏನು ನಿರೀಕ್ಷಿಸುತ್ತೀರಿ?"
    ]
  },
  hi: {
    navHome: "मुख्य पृष्ठ",
    ...
    questions: [
      "हाल के दिनों में आपके मन में क्या चल रहा है?",
      "इसका आपकी नींद, दिनचर्या या तनाव पर क्या प्रभाव पड़ा है?",
      "क्या आपने कोई शारीरिक बेचैनी या थकान महसूस की है?",
      "थेरेपी सत्रों से आपकी क्या अपेक्षाएं हैं?"
    ]
  },
  ml: {
    navHome: "ഹോം",
    ...
    questions: [
      "കുറച്ചു ദിവസങ്ങളായി മനസ്സിൽ എന്താണ് ഉള്ളത്?",
      "ഇത് നിങ്ങളുടെ ഉറക്കത്തെയോ ദിനചര്യയെയോ എങ്ങനെ ബാധിച്ചു?",
      "ശരീരത്തിൽ എന്തെങ്കിലും സമ്മർദ്ദമോ ക്ഷീണമോ അനുഭവപ്പെടുന്നുണ്ടോ?",
      "തെറാപ്പി സെഷനുകളിൽ നിന്ന് എന്താണ് പ്രതീക്ഷിക്കുന്നത്?"
    ]
  },
  ta: {
    navHome: "முகப்பு",
    ...
    questions: [
      "கடந்த சில நாட்களாக உங்கள் மனதில் என்ன இருக்கிறது?",
      "இது உங்கள் தூக்கத்தையோ அன்றாட வாழ்க்கையையோ எவ்வாறு பாதித்துள்ளது?",
      "உடலில் ஏதேனும் சோர்வு அல்லது பதற்றத்தை உணர்கிறீர்களா?",
      "சிகிச்சையிலிருந்து நீங்கள் என்ன எதிர்பார்க்கிறீர்கள்?"
    ]
  },
  te: {
    navHome: "హోమ్",
    ...
    questions: [
      "గత కొన్ని రోజులుగా మీ మనస్సులో ఏమి నడుస్తోంది?",
      "ఇది మీ నిద్రపై లేదా దినచర్యపై ఎలాంటి ప్రభావం చూపింది?",
      "శరీరంలో అలసట లేదా ఒత్తిడి వంటి భావనలు ఏమైనా గమనించారా?",
      "థెరపీ సెషన్ల నుండి మీ అంచనాలు ఏమిటి?"
    ]
  },
  mr: {
    navHome: "मुख्यपृष्ठ",
    ...
    questions: [
      "गेल्या काही दिवसांत तुमच्या मनात काय चालले आहे?",
      "याचा तुमच्या झोपेवर किंवा दैनंदिन दिनचर्येवर कसा परिणाम झाला आहे?",
      "तुम्हाला काही शारीरिक थकवा किंवा अस्वस्थता जाणवली आहे का?",
      "थेरपी सत्रांकडून तुमच्या काय अपेक्षा आहेत?"
    ]
  },
  bn: {
    navHome: "হোম",
    ...
    questions: [
      "গত কয়েকদিন ধরে আপনার মনে কি চলছে?",
      "এটি আপনার ঘুম বা দৈনন্দিন জীবনে কীভাবে প্রভাব ফেলেছে?",
      "আপনি কি কোনো শারীরিক ক্লান্তি বা অস্থিরতা অনুভব করেছেন?",
      "থেরাপি সেশন থেকে আপনার প্রত্যাশা কি?"
    ]
  }
};
